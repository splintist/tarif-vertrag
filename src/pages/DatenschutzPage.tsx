...
export function DatenschutzPage() {
  return (
    <>
      <Helmet>
        <title>Datenschutzerklärung - tarif-vertrag.org</title>
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="prose prose-blue max-w-none">
          ...
          <p>E-Mail: tarif-vertrag@mailbox.org</p>
          <p>Verantwortliche Stelle ist die nat&uuml;rliche oder juristische Person, die allein oder gemeinsam mit anderen &uuml;ber die Zwecke und Mittel der Verarbeitung von personenbezogenen Daten (z.&nbsp;B. Namen, E-Mail-Adressen o. &Auml;.) entscheidet.</p>

          <h2>5. Impressum-Privatschutz (IP-Management)</h2>
          <p>Wir verwenden für die Verwaltung der an uns gesendeten Post die Dienstleistungen der IMPRESSUMPRIVATSCHUTZ GmbH, Ludwig-Erhard-Str. 18, 20459 Hamburg. Dieser Dienstleister bietet eine sichere und zuverlässige Postanschrift für unser Projekt (z.B. Impressum, Datenschutzerklärung, Widerrufsbelehrung und ggf. weitere Bereiche). Dies stellt auch unser berechtigtes Interesse im Sinne des Art. 6 Abs. 1 lit. f DSGVO dar. Wir haben mit Impressum-Privatschutz einen Vertrag zur Auftragsverarbeitung abgeschlossen und setzen die strengen Vorgaben der deutschen Datenschutzbehörden bei der Nutzung dieser Dienstleistung vollständig um. Weitere Informationen über Datenschutz bei Impressum-Privatschutz GmbH finden Sie hier: <a href="https://impressum-privatschutz.de/datenschutzerklaerung/" className="text-blue-600 hover:text-blue-800">https://impressum-privatschutz.de/datenschutzerklaerung/</a></p>
